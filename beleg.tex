...
\newcommand{\thesisSubtitle}{Erstellung eines Konzeptes zur Synchronisierung von Daten und Bildern zwischen mobilen Endger\"{a}ten und einem Server bei unbest\"{a}ndiger Internetverbindung.}
...
\newcommand{\thesisDate}{06. Mai 2014}
...
\newcommand{\thesisUniversityStreetAddress}{Hans-Grundig-Strasse 25}
...
\input{Inhalt/Synchronisation} % INCLUDE: Synchronisationssoftware
